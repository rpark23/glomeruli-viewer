...
// app/api/get-mask-url/[filename]/route.ts
// import { NextResponse } from 'next/server';
...
//   { params }: { params: { filename: string } }
// ) {
//   // The original filename (e.g., "image1.jpg") is passed in the URL
//   const jpgFilename = params.filename;

//   // Simply construct the public URL for the corresponding mask
//   const maskFilename = jpgFilename.replace('.jpg', '_mask.png');
//   const maskUrl = `/masks/${maskFilename}`; // This is the public path

//   // Return the URL as JSON
//   return NextResponse.json({ url: maskUrl });
// }